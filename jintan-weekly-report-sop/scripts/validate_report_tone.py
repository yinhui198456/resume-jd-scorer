...
FUZZY_PATTERNS = [
    ...
    (r'大家好|各位好', '废话开场 — 删除'),
    (r'以上.*谢谢', '废话结尾 — 删除'),
    (r'继续跟进', '空泛行动 — 应给出具体下一步'),
    (r'持续跟进', '空泛行动 — 应给出具体下一步'),
    (r'保持关注', '空泛行动 — 应给出具体动作'),
    (r'同步一下', '口语化 — 应改为"同步"或"通知"'),
    (r'确认一下', '口语化 — 应改为"确认"'),
    (r'沟通一下', '口语化 — 应改为"沟通"'),
]
...
def check_quality_language(text):
    ...
    quality_patterns = [
        ...
        (r'跟\w+(?:说一下|讲一下|对一下)', '口语化 — 建议改为"与...确认"或"通知..."'),
        (r'约一下', '口语化 — 建议改为"预约"或"协调时间"'),
        (r'碰一下', '口语化 — 建议改为"开会讨论"或"对齐"'),
        (r'搞一下', '口语化 — 建议改为"处理"或"实施"'),
    ]
